...
defined( 'WSAK_VERSION' ) || define( 'WSAK_VERSION', '0.7.0' );
defined( 'WSAK_FILE' ) || define( 'WSAK_FILE', __DIR__ . '/../wowstudio-accessibility-remediation.php' );
defined( 'WSAK_PATH' ) || define( 'WSAK_PATH', dirname( __DIR__ ) . '/' );
defined( 'WSAK_URL' ) || define( 'WSAK_URL', 'https://example.test/wp-content/plugins/wowstudio-accessibility-remediation/' );
defined( 'WSAK_BASENAME' ) || define( 'WSAK_BASENAME', 'wowstudio-accessibility-remediation/wowstudio-accessibility-remediation.php' );
