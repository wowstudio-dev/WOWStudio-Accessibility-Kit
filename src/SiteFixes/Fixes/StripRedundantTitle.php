...
final class StripRedundantTitle implements RunsInBrowser {
	...
	public function title(): string {
		return __( 'Remove tooltips that repeat the link text', 'wowstudio-accessibility-remediation' );
	}
	...
	public function caveat(): string {
		return __( 'Only exact duplicates are removed, and never from an iframe or an abbreviation, where the title is the element\'s real name. Runs in the browser, so it does nothing with JavaScript off.', 'wowstudio-accessibility-remediation' );
	}
